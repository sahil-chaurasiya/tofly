...
const seedData = async () => {
  ...
  const services = await Service.insertMany([
    ...
    },
    {
      ...
      shortDescription: 'Data-driven digital marketing that grows your brand and drives measurable revenue.',
      description: 'From SEO, SMM, PPC, SEM, and SMO to Email & WhatsApp marketing campaigns, we deliver fully integrated digital marketing strategies that create real, measurable business impact and sustainable growth.',
      icon: 'BarChart2',
      order: 5,
      features: [
        { title: 'SEO, SMM, PPC, SEM & SMO', description: 'Dominate search rankings, grow social presence, and drive high-intent traffic through paid and organic strategies across every major platform' },
        { title: 'Paid Campaigns', description: 'High-converting ad campaigns on Google, Meta, and LinkedIn — optimized for maximum ROI' },
        { title: 'Email & WhatsApp Marketing', description: 'Automated Email and WhatsApp sequences that nurture leads, re-engage customers, and convert at scale' }
      ],
