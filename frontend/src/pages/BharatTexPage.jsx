    ...
    <PageWrapper>
        ...
        <div className="container-site relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-stone-500 max-w-xl mb-8">
              ...
              <div className="flex flex-wrap items-center gap-3 mb-10 text-sm text-stone-600">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-16">
            {QUICK_FACTS.map((f, i) => (
              ...
              >
                <div className="text-2xl md:text-3xl font-display gradient-text">{f.value}</div>
                <div className="text-xs text-stone-500 mt-1">{f.label}</div>
              </motion.div>
            ))}
          </div>
        </div>
          ...
          <div className="flex items-center justify-center gap-3 md:gap-6 flex-wrap">
            {[
              ...
              <div key={label} className="glass-card px-5 py-4 md:px-7 md:py-5 min-w-[84px]">
                <div className="text-3xl md:text-4xl font-display text-ink-900 tabular-nums">
                  {String(val).padStart(2, '0')}
                </div>
                <div className="text-[11px] text-stone-500 mt-1 uppercase tracking-wide">{label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <SectionWrapper className="container-site pb-24">
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <h2 className="section-heading text-ink-900 mt-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {PILLARS.map((p, i) => (
            ...
            >
              ...
              <h3 className="text-lg font-bold text-ink-900 mb-3">{p.title}</h3>
      ...
      <SectionWrapper className="container-site pb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {HIGHLIGHTS.map((card, i) => (
            ...
            >
              ...
              <h3 className="text-lg font-bold text-ink-900 mb-3">{card.title}</h3>
        ...
        >
          <p className="text-stone-600 text-base md:text-lg leading-relaxed max-w-3xl mx-auto italic">
          ...
          <p className="text-stone-400 text-sm mt-4">— Shri Narendra Modi, Hon'ble Prime Minister of India</p>
        </motion.div>
      </SectionWrapper>
      ...
      <SectionWrapper className="container-site pb-28">
        <div className="max-w-2xl mx-auto text-center glass-card p-10 md:p-12">
          <h2 className="text-2xl font-bold text-ink-900 mb-3">Exhibiting at Bharat Tex 2026?</h2>
