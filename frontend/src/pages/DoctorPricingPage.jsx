...
const DIGITAL_SERVICES = [
  { icon: MapPin,       title: 'Local SEO & Google Maps', desc: 'Rank at the top for "doctor near me" and specialty keywords. We optimize your clinic to attract patients searching in your area right now.', color: '#1E88E5' },
  { icon: Target,       title: 'Google Ads for Patients',  desc: 'High-intent patient acquisition campaigns. Get instant visibility and qualified appointment inquiries from day one.', color: '#26A69A' },
  { icon: Globe,        title: 'Clinic Website Development', desc: 'Professional, mobile-first clinic websites with appointment booking, doctor profiles, and patient resources.', color: '#1E88E5' },
  { icon: CalendarCheck,title: 'Appointment Booking System', desc: 'Automated online scheduling, SMS/WhatsApp reminders, and seamless patient intake — fewer no-shows, more revenue.', color: '#26A69A' },
  { icon: Star,         title: 'Reputation Management',    desc: 'Build and protect your online reputation. We help you collect glowing reviews on Google, Practo, and Justdial.', color: '#1E88E5' },
  { icon: Share2,       title: 'Social Media (Health Content)', desc: 'Educational content that positions you as an expert, builds patient trust, and keeps your clinic top-of-mind.', color: '#26A69A' },
]
    ...
    <>
      ...
      >
        ...
        <div style={{ position: 'relative', zIndex: 2 }}>
          ...
          {/* ── HERO ─────────────────────────────────────────────────────────── */}
          <div ref={heroRef} className="med-hero-section">
            <motion.div
                ...
                {[
                  ...
                  <div key={i} style={{ textAlign: 'center' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 6, justifyContent: 'center', marginBottom: 4 }}>
                      ...
                      <span style={{ fontSize: 'clamp(22px, 5vw, 30px)', fontWeight: 800, color: '#1A2B4A', fontFamily: 'Fraunces, serif' }}>{s.value}</span>
                    </div>
          ...
          <div style={{ background: '#EBF5FB', padding: '64px 0', marginBottom: 80 }}>
            <div className="med-section-wrap" style={{ marginBottom: 0 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 32, alignItems: 'center' }}>
                ...
                <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                  <div style={{ background: '#fff', border: '1.5px solid #AED6F1', borderRadius: 24, padding: 32, boxShadow: '0 4px 20px rgba(30,136,229,0.08)' }}>
          ...
          <div className="med-wide-wrap">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 24 }}>
              {DIGITAL_SERVICES.map((s, i) => (
                <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.05 }} className="med-service-card">
                  <div style={{ width: 56, height: 56, borderRadius: 14, background: `${s.color}12`, border: `1.5px solid ${s.color}30`, display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 20px' }}>
                    <s.icon size={26} color={s.color} strokeWidth={1.5} />
                  </div>
                  <h4 style={{ fontSize: 17, fontWeight: 700, color: '#1A2B4A', marginBottom: 12, fontFamily: 'Fraunces, serif' }}>{s.title}</h4>
          ...
          <div style={{ maxWidth: 800, margin: '80px auto 0', padding: '0 20px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 16 }}>
              {[
                { quote: 'Within 8 weeks we went from 12 walk-ins a week to 35+ confirmed appointments. Our Google rating went from 3.8 to 4.7 stars.', name: 'Dr. Ravi M.', role: 'Orthopaedic Surgeon, Pune', color: '#1E88E5' },
                { quote: 'I used to depend entirely on hospital referrals. Now 60% of my new patients find me on Google. The ROI has been phenomenal.', name: 'Dr. Sunita K.', role: 'Dermatologist, Delhi', color: '#26A69A' },
                { quote: 'The automated booking and WhatsApp reminders alone reduced no-shows by 40%. That\'s real revenue I was losing every month.', name: 'Dr. Prashant J.', role: 'Dentist, Bengaluru', color: '#1E88E5' },
              ].map((t, i) => (
