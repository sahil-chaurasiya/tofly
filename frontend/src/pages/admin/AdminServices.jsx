    ...
    <div className="space-y-5 sm:space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button onClick={openNew} className="btn-primary text-sm">
          <Plus size={16} /> <span className="hidden sm:inline">Add Service</span><span className="sm:hidden">Add</span>
        </button>
      </div>
              ...
              {isLoading ? (
                ...
                services.map(service => (
                  <tr key={service._id} className="border-b border-white/3 hover:bg-white/2 transition-colors">
                    <td className="px-4 sm:px-5 py-4 text-sm text-white/35 w-14">{service.order}</td>
                    <td className="px-4 sm:px-5 py-4">
                      <div className="text-sm font-medium text-white whitespace-nowrap">{service.title}</div>
                      <div className="text-xs text-white/30 mt-0.5 truncate max-w-[140px]">/{service.slug}</div>
                    </td>
                    <td className="px-4 sm:px-5 py-4 text-sm text-white/45" style={{ maxWidth: '220px' }}>
