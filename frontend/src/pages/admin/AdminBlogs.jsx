              ...
              data.map(blog => (
                <tr key={blog._id} className="border-b border-white/3 hover:bg-white/2 transition-colors">
                  <td className="px-5 py-4">
                    <div className="text-sm font-medium text-white line-clamp-1 max-w-xs">{blog.title}</div>
                    <div className="text-xs text-white/30 mt-0.5">/{blog.slug}</div>
                  </td>
                  <td className="px-5 py-4">
                    <span className="section-tag text-xs">{blog.category}</span>
                  </td>
                  <td className="px-5 py-4">
                  ...
                  <td className="px-5 py-4 text-sm text-white/40">{blog.views || 0}</td>
