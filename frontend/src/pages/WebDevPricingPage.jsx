...
const CLIENTS = [
  ...
  { name: 'Little Ninja Gym',          logo: '/logos/little-ninja.jpg',          colorLogo: false },
  { name: 'Origins',                   logo: '/logos/origins.png',                   colorLogo: false },
  { name: 'Ivoryy',                    logo: '/logos/ivoryy.jpg',                    colorLogo: false },
...
const INDUSTRIES = [
  {
    ...
    projects: [
      { name: 'Global Gas',           url: 'https://www.globalgas.com', thumb: '/portfolio/globalgas.jpg'    },
      { name: 'Mercurius',            url: 'https://masllp.com', thumb: '/portfolio/mercurius.jpg'    },
      { name: 'RegalFinx',            url: 'https://www.regalfinx.com', thumb: '/portfolio/toneopeats.jpg'   },
      { name: 'Digital Omnicon',      url: 'https://digitalomnicon.com', thumb: '/portfolio/digital.jpg'      },
      { name: 'ToneOpEats',           url: 'https://toneopeats.com', thumb: '/portfolio/success.jpg'      },
    ],
  },
  {
    id: 'ecommerce',
    ...
    projects: [
      { name: 'Brazilian Style',      url: 'https://www.brazilianstyleee.com', thumb: '/portfolio/fashion.jpg'      },
      { name: 'Origins Hyderabad',  url: 'https://www.originshyderabad.com/', thumb: '/portfolio/origins.jpg'      },
      { name: 'KWC Watches',        url: 'https://www.krishnawatch.com/', thumb: '/portfolio/kwc.jpg'          },
    ],
  },
  {
    id: 'hospitals',
    ...
    projects: [
      { name: 'Seawoods Support',   url: 'https://seawoodssupportsystems.com/', thumb: '/portfolio/seawoods.jpg'     },
      { name: 'Krishna Cancer',     url: 'https://krishnacancerhospital.com/', thumb: '/portfolio/krishna.jpg'      },
      { name: 'Rudra Clinic',       url: 'https://www.therudraclinic.com/', thumb: '/portfolio/spine.jpg'        },
      { name: 'Natural Cosmetic',   url: 'https://draakanshjain.com/', thumb: '/portfolio/natural.jpg'      },
    ],
  },
  {
    id: 'astrology',
    ...
    projects: [
      { name: 'InstaAstro',         url: 'https://instaastro.com/talktoastrologer/', thumb: '/portfolio/instaastro.jpg'   },
      { name: 'Astro Praveen Kumar',url: 'https://astropraveenkumar.com/', thumb: '/portfolio/anytimeastro.jpg' },
      { name: 'HiAstro',            url: 'https://www.hiastro.in/', thumb: '/portfolio/premium-astro.jpg'},
      { name: 'Dr. Sohini Sastri',  url: 'https://sohinisastri.com/', thumb: '/portfolio/sohini.jpg'       },
    ],
  },
  {
    id: 'education',
    ...
    projects: [
      { name: 'Online Coaching',    url: 'https://www.coaching.com/', thumb: '/portfolio/coaching.jpg'     },
      { name: 'Vision IAS',         url: 'https://www.visionias.in/bhopal/', thumb: '/portfolio/vision.jpg'       },
     ],
  },
  {
    id: 'realestate',
    label: 'Real Estate',
    projects: [
      { name: 'Amaltas India',      url: 'https://www.amaltasindia.com/', thumb: '/portfolio/amaltas.jpg'      },
      { name: 'Estatex Landbase',   url: 'https://estatexlandbase.com/', thumb: '/portfolio/estatex.jpg'      },
      { name: 'Quick Furnish',      url: 'https://quickfurnish.co/home/', thumb: '/portfolio/dreamhome.jpg'    },
      { name: 'Arihant Dream Homes',       url: 'https://arihantdhomes.com/', thumb: '/portfolio/buck.jpg'         },
    ],
  },
  {
    id: 'restaurant',
    ...
    projects: [
      { name: 'Cafe Handcrafted',   url: 'https://www.cafehandcrafted.com/', thumb: '/portfolio/openhouse.jpg'    },
      { name: 'Chainagri',          url: 'https://chainagri.in/', thumb: '/portfolio/ratnagiri.jpg'    },
      { name: 'Open House Cafe',    url: 'https://www.openhousecafe.in/', thumb: '/portfolio/coffeecountry.jpg'},
    ],
  },
  {
    id: 'hotel',
    ...
    projects: [
      { name: 'Graces Resort MP',   url: 'https://gracesresort.com/', thumb: '/portfolio/graces.jpg'       },
      { name: 'Jaipur Haveli',    url: 'https://jaipurhaveli.com/', thumb: '/portfolio/jaipur.jpg'       },
    ],
  },
  {
    id: 'travel',
    label: 'Tour & Travel',
    projects: [
      { name: 'Klook',      url: 'https://www.klook.com/en-IN/experiences/list/goa-tours/c178-cate9/', thumb: '/portfolio/goatours.jpg'     },
      { name: 'Trav Bunch',url:'https://travbunch.com/', thumb: '/portfolio/fromwhere.jpg'    },
      { name: 'Sterling Vacations',  url: 'https://sterlingvacations.co.in/', thumb: '/portfolio/cityguide.jpg'    },
      { name: 'Udaipur Traveling',  url: 'https://www.udaipurtraveling.com/', thumb: '/portfolio/udaipur.jpg'      },
    ],
  },
  {
    id: 'manufacturing',
    ...
    projects: [
      { name: 'Ikon Organic',     url: 'https://www.ikonorganic.com/', thumb: '/portfolio/spices.jpg'       },
      { name: 'Million Cases',      url: 'https://millioncases.com/', thumb: '/portfolio/millioncases.jpg' },
      { name: 'Baxsaa Co',       url: 'https://thebaxsaaco.com/', thumb: '/portfolio/packaging.jpg'    },
    ],
  },
]
