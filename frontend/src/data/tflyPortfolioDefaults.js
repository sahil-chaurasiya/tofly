// Fallback content for the /tofly-portfolio page. This is used ONLY if the
// live API can't be reached (e.g. offline preview) so the page still
// renders something sensible. The real, editable copy lives in the
// database and is managed from Admin -> Tofly Portfolio; this file is not
// read from there and does not need to be kept in sync for the site to work.

const TFLY_PORTFOLIO_DEFAULTS = {
  key: 'tofly-portfolio',
...
export default TFLY_PORTFOLIO_DEFAULTS;