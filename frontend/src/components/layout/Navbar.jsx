        ...
        <Link to="/" className="flex items-center group" style={{ textDecoration: 'none' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1px', lineHeight: 1 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-end', position: 'relative' }}>
              ...
              {/* SVG swoosh + plane overlaid after the "y" */}
              <svg width="34" height="20" viewBox="0 0 34 20"
                style={{ marginLeft: '-6px', marginBottom: '4px', flexShrink: 0 }}>
                {/* Curved swoosh line */}
                <path d="M1 16 Q16 5 32 2" stroke="white" strokeWidth="1.3" fill="none" strokeLinecap="round" opacity="0.85"/>
                {/* Paper plane triangle - gold */}
                <polygon points="29,0 34,5 26,6" fill="#FFD700"/>
                <polygon points="29,0 26,6 24,2" fill="#e6b800"/>
              </svg>
            </div>
            {/* "MEDIA" spaced out in gold */}
            <div style={{
              display: 'flex',
              gap: '4px',
              paddingLeft: '3px',
