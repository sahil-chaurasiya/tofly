...
import { Zap, MapPin, Phone, Mail, Instagram, Linkedin, Twitter, ArrowUpRight } from 'lucide-react'
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex items-center gap-2.5 mb-5 group w-fit">
              <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-brand-500 to-brand-700 flex items-center justify-center shadow-glow-sm group-hover:shadow-glow transition-all duration-300">
            ...
            <div className="flex items-center gap-3">
              {[
                { icon: Instagram, href: 'https://instagram.com/toflymedia', label: 'Instagram' },
                { icon: Linkedin, href: 'https://linkedin.com/company/toflymedia', label: 'LinkedIn' },
                { icon: Twitter, href: 'https://twitter.com/toflymedia', label: 'Twitter' },
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-sm text-white/45">Bhopal, Madhya Pradesh, India – 462001</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone size={16} className="text-brand-400 shrink-0" />
                <a href="tel:+919876543210" className="text-sm text-white/45 hover:text-white/80 transition-colors">
                  +91 98765 43210
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail size={16} className="text-brand-400 shrink-0" />
                <a href="mailto:hello@toflymedia.com" className="text-sm text-white/45 hover:text-white/80 transition-colors">
                  hello@toflymedia.com
                </a>
              </li>
            </ul>
            ...
            {/* WhatsApp CTA */}
            <a
              href="https://wa.me/919876543210?text=Hi%2C%20I'd%20like%20to%20know%20more%20about%20your%20digital%20marketing%20services."
              target="_blank"
              rel="noopener noreferrer"
